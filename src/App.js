...
import paypal from './component/paypal/paypal.json'
  ...
  useEffect(() => {
    ethereum.on("chainChanged", async (chainId) => {
      if(chainId == "0x3") {
        ...
        setCurrency("RopstenEther")
        setSymbol("rEth")
        setPaypalContractAddress('0xA95349733Fc8053448c70065Ae8E7C82462F72ce')
        setExplorer("https://ropsten.etherscan.io")
      } else if(chainId == "0x4") {
        setChain("Rinkeby")
        setCurrency("RinkebyEther")
        setSymbol("rEth")
        setPaypalContractAddress('0xB74F110EF5ABD3720D300EF619d2Cc263a150Df3')
        setExplorer("https://rinkeby.etherscan.io")
      } else if(chainId == "0x13881") {
        setChain("Polygon")
        setCurrency("Matic")
        setSymbol("Matic")
        setPaypalContractAddress('0x682438317a94cE9bB31915Bda482bb2F5001545F')
