  ...
  const LoginWallet = async () => {
    try {
      ...
      if(chainId == "0x3") {
        ...
        App.setSymbol("rEth")
        App.setLogin(true);
        App.setPaypalContractAddress('0xA95349733Fc8053448c70065Ae8E7C82462F72ce')
        ...
        App.setSymbol("rEth")
        App.setLogin(true);
        App.setPaypalContractAddress('0xB74F110EF5ABD3720D300EF619d2Cc263a150Df3')
        App.setExplorer("https://rinkeby.etherscan.io")
      } else if(chainId == "0x13881") {
        App.setChain("Polygon")
        App.setCurrency("Matic")
        App.setSymbol("Matic")
        App.setPaypalContractAddress('0x682438317a94cE9bB31915Bda482bb2F5001545F')
        App.setLogin(true);
