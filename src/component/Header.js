...
const Header = () => {
  ...
  return (
    <div className='w-full h-1/4 pt-4 flex justify-between items-start'>
      {/* logo */}
      <img className='h-12 ml-2' src='paypal.png' alt='logo' />
      ...
      <div className="flex justify-between items-start">
        ...
        {/* Chains Section */}
        <div onClick={() => setShowChains(true)} className="text-xl mr-2 font-sans border-opacity-60 border-2 border-blue-900 font-medium cursor-pointer bg-black px-4 py-2 text-white rounded-lg flex justify-between items-center">
        ...
        <div className={`${showChains ? '' : 'hidden'} absolute right-0 z-50`}>
          {/* Ropsten */}
          <div onClick={changeToRopsten} className='text-xl py-2 px-4 mr-2 font-sans border-opacity-60 border-2 border-blue-900 font-medium cursor-pointer hover:bg-gray-900 bg-black text-white rounded-lg flex justify-between items-center'>
            <img className='h-6 mr-2' src='ethereum-eth.svg' />
            Ropsten
          </div>
          {/* Polygon */}
          ...
          {/* Close the Chain */}
          <div onClick={() => setShowChains(false)} className='text-xl py-1 px-4 mr-2 font-sans border-opacity-60 border-2 border-blue-900 font-medium cursor-pointer hover:bg-red-600 bg-red-600 text-white rounded-lg flex justify-center items-center'>
            Close
